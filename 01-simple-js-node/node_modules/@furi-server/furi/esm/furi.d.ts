...
import { BodyParserOptions } from './middlewares/body-parser/body-parser.js';
...
export declare class Furi extends FuriRouter {
    ...
    static readonly BodyParser: (options?: BodyParserOptions) => any;
    static readonly JSONBodyParser: (options?: BodyParserOptions) => any;
    static readonly UrlEncodedParser: (options?: BodyParserOptions) => any;
