 ...
 */
export declare const LOG_DEBUG: (...s: string[]) => void;
export declare const LOG_INFO: (...s: string[]) => void;
export declare const LOG_LOG: (...s: string[]) => void;
export declare const LOG_WARN: (...s: string[]) => void;
export declare const LOG_ERROR: (...s: string[]) => void;
