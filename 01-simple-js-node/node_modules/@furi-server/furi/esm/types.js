 ...
 * API Version.
 */
export const API_VERSION = '0.2.7';
/**
 * Logging helper functions.
 */
export const LOG_DEBUG = (...s) => console.debug('DEBUG> ', ...s);
export const LOG_INFO = (...s) => console.info('INFO> ', ...s);
export const LOG_LOG = (...s) => console.log('LOG> ', ...s);
export const LOG_WARN = (...s) => console.warn('WARNING> ', ...s);
export const LOG_ERROR = (...s) => console.error('ERROR> ', ...s);
/**
