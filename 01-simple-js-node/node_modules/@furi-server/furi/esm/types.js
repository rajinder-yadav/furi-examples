 ...
 * API Version.
 */
export const API_VERSION = '0.2.8';
/**
 * Logging helper functions.
 */
export const LOG_DEBUG = (msg) => { if (Furi.bufferedLogger) {
    Furi.bufferedLogger.info(msg);
} };
export const LOG_INFO = (msg) => { if (Furi.bufferedLogger) {
    Furi.bufferedLogger.info(msg);
} };
export const LOG_LOG = (msg) => { if (Furi.bufferedLogger) {
    Furi.bufferedLogger.info(msg);
} };
export const LOG_WARN = (msg) => { if (Furi.bufferedLogger) {
    Furi.bufferedLogger.info(msg);
} };
export const LOG_ERROR = (msg) => { if (Furi.bufferedLogger) {
    Furi.bufferedLogger.info(msg);
} };
/**
