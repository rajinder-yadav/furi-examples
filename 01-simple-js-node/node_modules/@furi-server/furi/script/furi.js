...
const body_parser_js_1 = require("./middlewares/body-parser/body-parser.js");
...
__exportStar(require("./middlewares/cors/cors.js"), exports);
/**
...
*/
node_process_1.default.once('SIGTERM', () => {
    // Handler Linux signal to perform clean shutdown.
    Furi.shutDown(5000);
});
/**
