...
const buffered_logger_js_1 = require("./utils/buffered-logger.js");
    ...
    constructor() {
        ...
        try {
            ...
            if (this.furiConfig.logger.enabled) {
                Furi.bufferedLogger = new buffered_logger_js_1.BufferedLogger(node_process_1.default.cwd(), logFile, enabled, terminal, flushPeriod, maxCount, mode, level);
            }
        }
        catch (error) {
