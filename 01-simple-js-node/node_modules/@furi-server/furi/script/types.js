 ...
 * API Version.
 */
exports.API_VERSION = '0.2.7';
/**
 * Logging helper functions.
 */
const LOG_DEBUG = (...s) => console.debug('DEBUG> ', ...s);
exports.LOG_DEBUG = LOG_DEBUG;
const LOG_INFO = (...s) => console.info('INFO> ', ...s);
exports.LOG_INFO = LOG_INFO;
const LOG_LOG = (...s) => console.log('LOG> ', ...s);
exports.LOG_LOG = LOG_LOG;
const LOG_WARN = (...s) => console.warn('WARNING> ', ...s);
exports.LOG_WARN = LOG_WARN;
const LOG_ERROR = (...s) => console.error('ERROR> ', ...s);
