 ...
 * API Version.
 */
exports.API_VERSION = '0.2.8';
/**
 * Logging helper functions.
 */
const LOG_DEBUG = (msg) => { if (furi_js_1.Furi.bufferedLogger) {
    furi_js_1.Furi.bufferedLogger.info(msg);
} };
exports.LOG_DEBUG = LOG_DEBUG;
const LOG_INFO = (msg) => { if (furi_js_1.Furi.bufferedLogger) {
    furi_js_1.Furi.bufferedLogger.info(msg);
} };
exports.LOG_INFO = LOG_INFO;
const LOG_LOG = (msg) => { if (furi_js_1.Furi.bufferedLogger) {
    furi_js_1.Furi.bufferedLogger.info(msg);
} };
exports.LOG_LOG = LOG_LOG;
const LOG_WARN = (msg) => { if (furi_js_1.Furi.bufferedLogger) {
    furi_js_1.Furi.bufferedLogger.info(msg);
} };
exports.LOG_WARN = LOG_WARN;
const LOG_ERROR = (msg) => { if (furi_js_1.Furi.bufferedLogger) {
    furi_js_1.Furi.bufferedLogger.info(msg);
} };
